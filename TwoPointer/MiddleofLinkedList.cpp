...
public:
    ...
    ListNode * middleNode(ListNode * head) {
        ...
        ListNode *fast = head;  // fast points to 2 (If the length of list is even, return the value of center right one.) 
		//ListNode *fast = head->next; (If the lenght of list is even, return the value of center left one.)
